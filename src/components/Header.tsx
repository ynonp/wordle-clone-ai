...
export function Header({ onNewGame, onToggleHistory }: HeaderProps) {
  return (
    <header className="mb-4 flex items-center justify-between">
      <h1 className="text-2xl font-bold tracking-wide">Wordle Clone</h1>
      <div className="flex items-center gap-2">
        <button
          className="rounded bg-gray-700 px-3 py-1 text-sm font-semibold text-white hover:bg-gray-600"
